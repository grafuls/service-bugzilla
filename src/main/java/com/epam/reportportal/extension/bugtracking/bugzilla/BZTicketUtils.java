 ...
 */
public class BZTicketUtils {

//	private static final Logger LOGGER = LoggerFactory.getLogger(BZTicketUtils.class);
...
//	public static final String JIRA_FORMAT = "yyyy-MM-dd";
	...
	public static Ticket toTicket(Issue input, ExternalSystem details) {
		...
		ticket.setTicketUrl(details.getExternalSystemType().makeUrl(details.getUrl(), input.getId()));
		return ticket;
	}
